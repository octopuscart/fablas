...
App.controller('addShadiProfileController', function ($scope, $http, $timeout, $interval) {
    ...
    $scope.getSubCommunity = function () {
        ...
        var religiousurl = adminapiurl + "localApi/getSimpleTableDataById/set_community/category_id/" + $scope.religious.community;
    ...
    $scope.getStateCity = function () {
        ...
        var religiousurl = adminapiurl + "localApi/getSimpleTableDataById/set_cities/state_id/" + $scope.locationdata.state;
        $http.get(religiousurl).then(function (rdata) {
    ...
    $scope.getFamilyStateCity = function () {
        ...
        var religiousurl = adminapiurl + "localApi/getSimpleTableDataById/set_cities/state_id/" + $scope.familylocationdata.state;
        $http.get(religiousurl).then(function (rdata) {
...
App.controller('editShadiProfileController', function ($scope, $http, $timeout, $interval) {
...
//merital Status
    ...
    $scope.getSubCommunity = function () {
        ...
        $scope.religious.sub_community = "";
        var religiousurl = adminapiurl + "localApi/getSimpleTableDataById/set_community/category_id/" + $scope.memberData.profile.religion;
        $http.get(religiousurl).then(function (rdata) {
            $scope.religious.sub_community_list = rdata.data;
            $timeout(function () {
    ...
    $scope.getStateCity = function () {
        console.log($scope.locationdata);
        $scope.locationdata.city = "";
        var religiousurl = adminapiurl + "localApi/getSimpleTableDataById/set_cities/state_id/" + $scope.memberData.profile.birth_location_state;
        $http.get(religiousurl).then(function (rdata) {
            $scope.locationdata.city_list = rdata.data;
            $timeout(function () {
    ...
    $scope.getFamilyStateCity = function () {
        $scope.familylocationdata.city = "";
        var religiousurl = adminapiurl + "localApi/getSimpleTableDataById/set_cities/state_id/" + $scope.memberData.profile.family_location_state;
        $http.get(religiousurl).then(function (rdata) {
            $scope.familylocationdata.city_list = rdata.data;
            $timeout(function () {
...
App.controller('viewShadiProfileController', function ($scope, $http, $timeout, $interval) {
    ...
    $scope.removeProfileData = function () {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var deleteurl = adminapiurl + "localApi/deleteShadiProfileById";
...
App.controller('photosShadiProfileController', function ($scope, $http, $timeout, $interval) {
    $scope.memberData = {"photos": [], "selected": "", "profile": {}};
    var photourl = adminapiurl + "localApi/getShadiProfilePhotos/" + memberprofile;
...
App.controller('contactShadiProfileController', function ($scope, $http, $timeout, $interval) {
    $scope.memberData = {"contact": [], "selected": "", "profile": {}};
    var photourl = adminapiurl + "localApi/getShadiProfileContact/" + memberprofile;
    $http.get(photourl).then(function (rdata) {
